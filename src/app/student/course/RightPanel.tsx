      ...
      <div className="max-w-4xl mx-auto space-y-4">
        ...
        <div className="rounded-2xl overflow-hidden border border-slate-200 bg-white shadow-xl shadow-blue-900/5">
          ...
          {activeQuiz ? (
            ...
            /* ──────────────── VIDEO THUMBNAIL (ACCA THEMED) ──────────────── */
            <div className="relative aspect-video bg-slate-950 overflow-hidden flex items-center justify-center">
               {/* Background ACCA Texture */}
               ...
               <div className="relative z-10 text-center px-6">
                 ...
                 <div className="mt-8 py-3 px-6 bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl inline-block">
               ...
               <div className="absolute top-6 left-6 flex items-center gap-2">
                 ...
                 <span className="text-xs font-bold text-white/50 tracking-widest">ACCA ACADEMY</span>
               </div>
            </div>
          )}
        </div>
        ...
        <div className=" grid-cols-1 md:grid-cols-2 gap-4 hidden md:grid">
          ...
          <div className="bg-slate-900 rounded-2xl p-6 border border-slate-800 shadow-sm text-white">
            ...
            <div className="mt-4 pt-4 border-t border-white/10 flex justify-between items-center">
              ...
              <span className="text-[10px] font-bold bg-blue-500/20 text-blue-400 px-2 py-0.5 rounded border border-blue-500/30 uppercase">
