          ...
          <div className="flex items-center gap-6">
            ...
            <div className="space-y-1">
              <div className="flex items-center gap-3">
                ...
                <div className={`px-2 py-0.5 rounded-md text-[10px] font-black uppercase tracking-tighter border ${
                  isPaid ? 'border-cyan-400/50 text-cyan-300 bg-cyan-400/10' : 'border-blue-400/50 text-blue-300 bg-blue-400/10'
                }`}>
              ...
              <p className="flex items-center gap-2 text-sm font-medium text-blue-200/60">
                ...
                Learning Path: <span className="text-white">{course?.name ?? "General Course"}</span>
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-4 lg:gap-6">
            ...
            <div className="bg-blue-900/20 border border-blue-400/20 rounded-2xl p-4 min-w-[140px] flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-xl font-black text-white leading-none">{activeModules.length}</p>
              </div>
            </div>
